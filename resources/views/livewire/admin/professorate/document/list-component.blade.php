<div>
    ...
    <div class="flex justify-between pt-2">
        ...
        <div class="text-right mb-4 ml-4 text-lg leading-7 font-semibold dark:text-gray-100">
            <div class="flex justify-start pt-2">
                ...
                <div class="mr-2">Documentos registrados</div>                
            </div>            
        </div>
    ...
    @if ($modeEdit)
        ...
        <div class="mb-4 pb-4"> 
            @include('livewire.admin.professorate.document.form.edit')
        </div>
    ...
    @if ($modeCreate)
        ...
        <div class="mb-4 pb-4">
            @include('livewire.admin.professorate.document.form.create')
        </div>
    ...
    <div class="mx-4 px-4">
        @include('livewire.admin.professorate.document.table.index')
    </div>
