<div>
        ...
        @if ($modeEdit)
            ...
            <div class="mb-4 pb-4"> 
                @include('livewire.admin.institution.section.form.edit')
            </div>
        ...
        @if ($modeCreate)
            ...
            <div class="mb-4 pb-4">
                @include('livewire.admin.institution.section.form.create')
            </div>
    
        @endif    
    
        <div class="mx-4 px-4">
            @include('livewire.admin.institution.section.table.index')
        </div>    
