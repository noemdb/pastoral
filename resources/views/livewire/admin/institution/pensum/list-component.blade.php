<div>
        ...
        @if ($modeEdit)
            ...
            <div class="mb-4 pb-4"> 
                @include('livewire.admin.institution.pensum.form.edit')
            </div>
        ...
        @if ($modeCreate)
            ...
            <div class="mb-4 pb-4">
                @include('livewire.admin.institution.pensum.form.create')
            </div>
        ...
        <div class="mx-4 px-4">
            @include('livewire.admin.institution.pensum.table.index')
        </div>
