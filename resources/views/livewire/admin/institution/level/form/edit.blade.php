<div class="p-2 m-2 rounded shadow bg-gray-100 dark:bg-gray-800 ">
    <div class="flex justify-between">
        <div class="flex justify-between w1/2">
            <h1 class="block font-semibold text-lg text-gray-700 dark:text-gray-100">Edición de datos del <span class="text-gray-500">Nivel Educativo.</span></h1>
        </div>                
    ...
    <form wire:submit.prevent="save">
        ...
        @include('livewire.admin.institution.level.form.fields')
