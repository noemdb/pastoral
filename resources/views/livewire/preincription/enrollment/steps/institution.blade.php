<div wire:key="institution">
    ...
    <div class="animate__animated animate__fadeIn" >
        ...
        <div class="mb-4 ">
            ...
            <x-select name="pastoral_id" id="pastoral_id" wire:model="pastoral_id" :options="$pastorals_list" class=" w-full " />
        ...
        @if ($pastoral)
            ...
            <div class="mb-4">
                ...
                <x-select name="curriculum_id" id="curriculum_id" wire:model="curriculum_id" :options="$curriculum_list" class=" w-full " />
