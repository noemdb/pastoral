<div wire:key="representant">
	...
	<div class="animate__animated animate__fadeIn" >
		...
		<div class="mb-4">
		    ...
		    <x-input wire:model.defer="representant_ci" id="representant_ci" name="representant_ci" class="block mt-1 w-full @error('representant_ci') is-invalid @else is-valid @enderror" />
		...
		<div class="mb-4">
		    ...
		    <x-input wire:model.defer="representant_name" name="representant_name" class="block mt-1 w-full @error('representant_name') is-invalid @else is-valid @enderror" />
