<div wire:key="address">
    ...
    <div class="animate__animated animate__fadeIn" >
        ...
        <div class="mb-4">
            ...
            <div wire:loading wire:target="loadState" class=" text-gray-400 text-sm">Obteniendo estados...</div>
        ...
        @if ($country)
            <div class="mb-4">
                <div wire:loading wire:target="loadCity" class=" text-gray-400 text-sm">Obteniendo ciudades...</div>
