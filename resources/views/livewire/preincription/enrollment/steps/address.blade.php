<div wire:key="address">
    ...
    <div class="animate__animated animate__fadeIn" >
        ...
        <div class="mb-4">
            ...
            <x-select name="country_id" id="country_id" wire:model="country_id" :options="$country_list" class=" w-full " />
        ...
        @if ($country)
            <div class="mb-4">
                ...
                <x-select name="state_id" id="state_id"  wire:model="state_id"  :options="$state_list" class=" w-full " />
