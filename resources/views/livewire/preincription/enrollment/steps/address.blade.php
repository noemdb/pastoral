<div wire:key="address">
    ...
    <div class="animate__animated animate__fadeIn" >
        ...
        <div class="mb-4">
            ...
            <div class="@error('country_id') p-2 border-2 rounded  border-rose-600 bg-red-50 @enderror">
        ...
        @if ($country)
            <div class="mb-4">
                ...
                <div class="@error('state_id') p-2 border-2 rounded  border-rose-600 bg-red-50 @enderror">
            ...
            @if ($state)
                ...
                <div class="mb-4">                    
                    ...
                    <div class="@error('city_id') p-2 border-2 rounded  border-rose-600 bg-red-50 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <div class="@error('dir_address') p-2 border-2 rounded  border-rose-600 bg-red-50 @enderror">
                    <x-input wire:model.lazy="dir_address"  name="dir_address" class="block mt-1 w-full @error('dir_address') is-invalid @else is-valid @enderror" />
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="@error('status_nacionality') p-2 border-2 rounded  border-rose-600 bg-red-50 @enderror">
