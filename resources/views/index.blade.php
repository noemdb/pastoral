                        ...
                        <div class="w-full sm:w-2/3 lg:w-1/3">
                            <div class="single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                ...
                                <div class="mt-8 services-content">
                                    ...
                                    <p class="mb-8">
                                        Se trata de un sistema que simplifica los procesos y actividades que ocurren dentro de éste proceso de formación, sin dejar la flexibilidad y fortaleza del modo antiguo de organización catequética.
                                    </p>
                ...
                <div class="row">
                    <div class="w-full lg:w-1/2">
                        <div class="mx-4 mt-12 about-content wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <p class="mb-8">Soportada por tecnologías de alto nivel, tales como: Laravel, tailwind y alpine entre otras </p>
                ...
                <div class="row">
                    <div class="w-full lg:w-1/2 lg:order-last">
                        <div class="mx-4 mt-12 about-content wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <p class="mb-8">
                            <ul>
                                <li class="ml-1">-. Elementos dispuestos estratégicamente para la fácil ubicación y manejo.</li>
                                <li class="ml-1">-. Diseño receptivo (Responsive), adaptable a cualquier tamaño de pantalla.</li>
                                <li class="ml-1">-. Siempre en actualización.</li>
                                <li class="ml-1">-. Información presentada en formatos limpios, legibles, en consonancia la frescura visual.</li>
                                <li class="ml-1">-. Optimización de velocidad.</li>
                                <li></li>
                            </ul>                            
                            </p>
                            <!-- <a href="javascript:void(0)" class="main-btn gradient-btn">Try it Free</a> -->
