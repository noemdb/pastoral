    <x-slot name="header">
        ...
        <x-jet-nav-link class=" shadow py-2 rounded" href="{{ route('institutions.index') }}" :active="request()->routeIs('institutions.index')">
            {{ __('Instituciones') }}            
        </x-jet-nav-link>

        <x-jet-nav-link class=" shadow py-2 rounded" href="{{ route('authorities.index') }}" :active="request()->routeIs('authorities.index')">
            {{ __('Autoridades') }}
        </x-jet-nav-link>
