                        ...
                        <div class="row">
                            ...
                            <div class="w-full lg:w-1/2 lg:order-first">
                                <div class="mx-4 mt-12 text-center about-image wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                                    <img src="assets/images/obstaculo.svg" alt="about">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pb-10 text-center section-title">
                    ...
                    <div class="container mb-4">
                        <div class="row">
                                ...
                                <div class="mx-4 mt-12 about-content wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                                    ...
                                    <p class="mb-8">
                                        <ul class="ml-4 text-left">
                                            ...
                                            <li>-. Pizarra de anuncios.</li>
                                            <li>-. Encuestas en línea.</li>
                                            <li>-. Autorrespondedor de mensajería instantanea.</li>
                                            <li>-. Blog de publicaciones.</li>
                                        </ul>                        
                                    </p>
                                </div>
                            </div>
                            <div class="w-full lg:w-1/2 lg:order-last">
                                <div class="mx-4 mt-12 text-center about-image wow fadeInRightBig" data-wow-duration="1s"  data-wow-delay="0.5s">
                                    <img src="assets/images/interactive.svg" alt="about">
                                </div>
                            </div>
                        </div>
                    </div>
