<div class="p-6 sm:px-20  bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100">
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100">
    <div class="p-6">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l dark:border-gray-700">
        <div class="flex items-center">
