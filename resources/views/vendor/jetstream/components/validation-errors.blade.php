@if ($errors->any())
    <div {{ $attributes->merge(['class' => 'mt-6 px-6 py-4 font-medium text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white']) }}>
