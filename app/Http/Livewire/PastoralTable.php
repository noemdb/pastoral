    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Editar')
               ->class('bg-indigo-500 cursor-pointer text-white px-3 py-2.5 my-1 rounded text-sm')
           ...
           Button::make('destroy', 'Eliminar')
               ->class('bg-red-600 cursor-pointer text-white px-3 py-2 my-1 rounded text-sm')
