...
class Rol extends Model
{
    ...
    {
        return ['SISTEMA'=>'SISTEMA','PRESIDENCIA'=>'PRESIDENCIA','DIRECCIÓN'=>'DIRECCIÓN','SECRETARÍA'=>'SECRETARÍA','COORDINACION'=>'COORDINACION','FORMADORES'=>'FORMADORES','POSTULANTADO'=>'POSTULANTADO','ASPIRANTADO'=>'ASPIRANTADO','COMUNIDAD'=>'COMUNIDAD'];
    }

    public static function list_rol() /* usada para llenar los objetos de formularios select*/
    {
        return ['ADMINISTRADOR'=>'ADMINISTRADOR','PRESIDENTE'=>'PRESIDENTE','DIRECTOR'=>'DIRECTOR','SECRETARIO'=>'SECRETARIO','COORDINADOR'=>'COORDINADOR','SUBCOORDINADOR'=>'SUBCOORDINADOR','CATEQUISTA'=>'CATEQUISTA','POSTULANTE'=>'POSTULANTE','COOPERADOR'=>'COOPERADOR','RELIGIOSO'=>'RELIGIOSO','SUPERVISOR'=>'SUPERVISOR','SUPLENTE'=>'SUPLENTE','JEFE'=>'JEFE','ASISTENTE'=>'ASISTENTE','CATEQUIZANDO'=>'CATEQUIZANDO','REPRESENTANTE'=>'REPRESENTANTE','PERSONAL'=>'PERSONAL'];
    }
}
